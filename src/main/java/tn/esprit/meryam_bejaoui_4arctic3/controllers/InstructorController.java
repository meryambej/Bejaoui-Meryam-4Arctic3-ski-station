...
public class InstructorController {
    ...
    public ResponseEntity<Instructor> addAndAssignToCourse(@RequestBody Instructor instructor, @PathVariable Long courseId) {
        return ResponseEntity.ok(instructorServices.addInstructorAndAssignToCourse(instructor, courseId));
    }
